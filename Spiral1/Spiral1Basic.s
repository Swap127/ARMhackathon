...
__main  FUNCTION
		...
		VLDR.F32 s25,=1440		;radius
		VLDR.F32 s13,=10       ;upper value of k
		
		VMOV.F32 s28,s10		;intial value 0 for the variable for loops in spiral 
		VLDR.F32 s29,=3			;final value for the number of spirals i.e.4

startc	MOV r7, 0				;initial angle 0
		MOV r6, 359			;final angle 360
		
		;Center Points
		;for the case of earth(i.e spiral1) the origin(0,0) is taken as centre points of the spiral  
...
starta	MOV r0, r7				;angle in degrees
		BL printMsg				;print the angle in degrees
		VSUB.F32 s25,s25,s12
